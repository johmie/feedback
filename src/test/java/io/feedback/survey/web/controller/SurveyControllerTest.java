...
class SurveyControllerTest {
    ...
    private static Object[] parametersForCorrectViewIsUsedTest() {
        return new Object[]{
    ...
    @Test
    void setPageService_SomePageService_SameValueIsReturnedByGetPageService() {
    ...
    @Test
    void setResultService_SomeResultService_SameValueIsReturnedByGetResultService() {
    ...
    @ParameterizedTest
    @MethodSource("parametersForCorrectViewIsUsedTest")
    void page_RequestMethodIsGet_CorrectViewIsUsed(Long surveyId, Integer pageNumber,
    ...
    @ParameterizedTest
    @MethodSource("parametersForCorrectViewIsUsedTest")
    void page_RequestMethodIsPost_CorrectViewIsUsed(long surveyId, int pageNumber,
                                                    Page.Type type, String expectedView) {
        createPageMock(surveyId, pageNumber, type);
    ...
    @Test
    void page_HttpServletRequestWithSessionId_SessionIdIsSetAsParticipationIdentifier() {
    ...
    @Test
    void page_HttpServletRequestWithRemoteAddress_RemoteAddressIsAppliedFromHttpServletRequest() {
    ...
    @Test
    void page_ResultsAreSaved_CorrectRedirectUrlIsReturned() {
        Long surveyId = 1L;
        Integer pageNumber = 1;
        HttpServletRequest httpServletRequestMock = createHttpServletRequestMock(null, null);
    ...
    @Test
    void page_RequestMethodIsGetAndPageTypeIsAsk_PageIsAddedToModel() {
        Long surveyId = 1L;
        Integer pageNumber = 1;
    ...
    @Test
    void page_RequestMethodIsPostAndPageTypeIsAsk_PageIsAddedToModel() {
        Long surveyId = 1L;
        Integer pageNumber = 1;
        Page pageMock = createPageMock(surveyId, pageNumber, Page.Type.ASK);
        Model modelMock = mock(Model.class);
    ...
    @Test
    void page_RequestMethodIsGetAndNoResultExceptionIsThrown_NotFoundExceptionIsThrown() {
        Long surveyId = 1L;
        Integer pageNumber = 1;
    ...
    @Test
    void page_RequestMethodIsPostAndNoResultExceptionIsThrown_NotFoundExceptionIsThrown() {
        Long surveyId = 1L;
        Integer pageNumber = 1;
        when(surveyController.getPageService().loadPage(surveyId, pageNumber)).thenThrow(NoResultException.class);
    ...
    @Test
    void handleNotFoundException_InstantiatedSurveyController_CorrectViewIsReturned() {
